...
const checkButton = document.getElementById("check-weather-button");
...
async function renderWeather() {
    checkButton.textContent = "Checking weather...";
    let weatherInfo = await getWeatherInfo();
    checkButton.textContent = "Check The Weather";
...
checkButton.addEventListener("click", renderWeather);
